        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              InputField(obscureText: false, hintText: 'Full Name'),
              SizedBox(height: 10),
              InputField(obscureText: false, hintText: 'Email address'),
              SizedBox(height: 10),
              InputField(obscureText: true, hintText: 'Password'),
              SizedBox(height: 10),
              InputField(obscureText: true, hintText: 'Confirm password'),
              SizedBox(height: 25),
              GestureDetector(
                onTap: () {
                  Navigator.push(
